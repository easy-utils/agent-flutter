...
class LocalDb extends _$LocalDb {
  LocalDb(this.scope)
      : super(driftDatabase(
          ...
          // user/tenant must never read another's sessions, drafts or unread
          // watermarks. See lib/scope.dart.
          name: 'agent_app_$scope',
  ...
  LocalDb.forExecutor(super.e) : scope = '';

  /// The connection scope this database belongs to (also part of the file
  /// name, kept so callers can assert/diagnose).
  final String scope;
