...
/// and metadata (change id, diff, +/- additions/deletions). EVERY tool renders
        ...
        children: [
          ...
          if (_open) ...[
            if (input.isNotEmpty)
              ...
              // before `tool-call` delivers the parsed input.
              _Section(
                title: context.l10n.toolInputParams,
                icon: AppIcons.braces,
                open: _inputOpen,
                onToggle: () => setState(() => _inputOpen = !_inputOpen),
                child: _MonoText(state!.inputText!),
              ),
            if (hasError)
              _Section(
